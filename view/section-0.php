...
?>
        <a href="#" data-toggle="modal" data-target="#modal-<?=$id.$k?>">
            <div class="col-lg-4">
                <img class="img-circle" src="<?=$p?>" alt="<?=$d?>" width="200" height="200">
                <p><?=$T->trans($d)?></p>
            </div>
        </a>

        <div id="modal-<?=$id.$k?>" class="modal fade" role="dialog" tabindex="-1">
